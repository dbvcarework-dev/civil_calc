...
router.post('/', async (req, res) => {
    try {
        ...
        const { moduleName, k1Table, k2Table, kdMap, kcMap, cityWindSpeeds, changes } = req.body;
        const config_json = { k1Table, k2Table, kdMap, kcMap, cityWindSpeeds };
        ...
        console.error("Error saving wind configuration:", error);
...
router.get('/logs', async (req, res) => {
    try {
        const moduleName = req.query.module || 'wind-load';
